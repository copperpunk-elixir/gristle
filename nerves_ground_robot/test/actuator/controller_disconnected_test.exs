defmodule Actuator.ControllerTest do
  ...
  test "Actuator Controller - not connected" do
    assert Actuator.Controller.get_message_for_channel_and_output_ms(0, 1500) == [0x84, 0, 112, 46, 43]
    assert Actuator.Controller.get_message_for_channel_and_output_ms(1, 1100) == [0x84, 1, 48, 34, 36]
