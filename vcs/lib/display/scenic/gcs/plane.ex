defmodule Display.Scenic.Gcs.Plane do
  ...
  def init(_, opts) do
    ...
    graph =
      ...
      |> Display.Scenic.Gcs.Utils.add_goals_to_graph(%{goal_id: {:goals, 3}, width: goals_width, height: 2*goals_height, offset_x: 110+label_value_width, offset_y: 10, labels: ["speed", "Course", "Altitude"], ids: [:speed_cmd, :course_cmd, :altitude_cmd], font_size: @font_size})
      |> Display.Scenic.Gcs.Utils.add_goals_to_graph(%{goal_id: {:goals, 2}, width: goals_width, height: 2*goals_height, offset_x: 110+label_value_width, offset_y: 2*goals_height + 40, labels: ["roll", "pitch", "yaw", "thrust"], ids: [:roll_cmd, :pitch_cmd, :yaw_cmd, :thrust_2_cmd], font_size: @font_size})
      |> Display.Scenic.Gcs.Utils.add_goals_to_graph(%{goal_id: {:goals, 1}, width: goals_width, height: 2*goals_height, offset_x: 110+label_value_width, offset_y: 4*goals_height + 70, labels: ["rollrate", "pitchrate", "yawrate", "thrust"], ids: [:rollrate_cmd, :pitchrate_cmd, :yawrate_cmd, :thrust_1_cmd], font_size: @font_size})
