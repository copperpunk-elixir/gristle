defmodule Display.Scenic.Gcs.Car do
  use Scenic.Scene
  require Logger
  ...
  def init(_, opts) do
    ...
    graph =
      ...
      |> Display.Scenic.Gcs.Utils.add_goals_to_graph(%{goal_id: {:goals, 3}, width: goals_width, height: 2*goals_height, offset_x: 110+label_value_width, offset_y: 10, labels: ["speed", "course"], ids: [:speed_cmd, :course_cmd], font_size: @font_size})
      |> Display.Scenic.Gcs.Utils.add_goals_to_graph(%{goal_id: {:goals, 2}, width: goals_width, height: 2*goals_height, offset_x: 110+label_value_width, offset_y: 2*goals_height + 40, labels: ["yaw", "thrust"], ids: [:yaw_cmd, :thrust_2_cmd], font_size: @font_size})
      |> Display.Scenic.Gcs.Utils.add_goals_to_graph(%{goal_id: {:goals, 1}, width: goals_width, height: 2*goals_height, offset_x: 110+label_value_width, offset_y: 4*goals_height + 70, labels: ["yawrate", "thrust"], ids: [:yawrate_cmd, :thrust_1_cmd], font_size: @font_size})
