defmodule Configuration.Vehicle.Plane.Pids.T28Z2m do
  require Logger
  ...
  def get_pids() do
    ...
    [
      rollrate: [aileron: Keyword.merge([type: :Generic, kp: 0.1, ki: 1.0, integrator_range: 0.26, integrator_airspeed_min: integrator_airspeed_min, ff: get_feed_forward(:rollrate, :aileron)], constraints[:aileron])],
      pitchrate: [elevator: Keyword.merge([type: :Generic, kp: 0.1, ki: 1.0, integrator_range: 0.26, integrator_airspeed_min: integrator_airspeed_min, ff: get_feed_forward(:pitchrate, :elevator)], constraints[:elevator])],
      yawrate: [rudder: Keyword.merge([type: :Generic, kp: 0.1, ki: 0.0, integrator_range: 0.26, integrator_airspeed_min: integrator_airspeed_min, ff: get_feed_forward(:yawrate, :rudder)], constraints[:rudder])],
  ...
  def get_constraints() do
    [
      ...
      speed: [output_min: 0, output_max: 30, output_neutral: 0, output_mid: 15],
