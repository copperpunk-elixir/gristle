defmodule Configuration.Vehicle.Plane.Pids.Cessna do
  ...
  def get_pids() do
    ...
    %{
      rollrate: %{aileron: Map.merge(%{kp: 0.6, ki: 1.0, integrator_range: 0.26, ff: get_feed_forward(:rollrate, :aileron)}, constraints.aileron)},
      pitchrate: %{elevator: Map.merge(%{kp: 0.6, ki: 1.0, integrator_range: 0.26, ff: get_feed_forward(:pitchrate, :elevator)}, constraints.elevator)},
      yawrate: %{rudder: Map.merge(%{kp: 0.3, ki: 0.0, integrator_range: 0.26, ff: get_feed_forward(:yawrate, :rudder)}, constraints.rudder)},
      roll: %{rollrate: Map.merge(%{kp: 2.0}, constraints.rollrate)},
      pitch: %{pitchrate: Map.merge(%{kp: 2.0}, constraints.pitchrate)},
      yaw: %{yawrate: Map.merge(%{kp: 2.0}, constraints.yawrate)},
