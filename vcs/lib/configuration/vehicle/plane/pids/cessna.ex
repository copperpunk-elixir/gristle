defmodule Configuration.Vehicle.Plane.Pids.Cessna do
  ...
  def get_pids() do
    ...
    %{
      rollrate: %{aileron: Map.merge(%{type: :Generic, kp: 0.6, ki: 1.0, integrator_range: 0.26, integrator_airspeed_min: integrator_airspeed_min, ff: get_feed_forward(:rollrate, :aileron)}, constraints.aileron)},
      pitchrate: %{elevator: Map.merge(%{type: :Generic, kp: 0.6, ki: 1.0, integrator_range: 0.26, integrator_airspeed_min: integrator_airspeed_min, ff: get_feed_forward(:pitchrate, :elevator)}, constraints.elevator)},
