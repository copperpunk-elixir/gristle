defmodule Configuration.Vehicle.Multirotor.Actuation do
  ...
  def get_actuator_sorter_intervals() do
    [
      ...
      indirect_actuator_sorter_interval_ms: Configuration.Generic.get_loop_interval_ms(:fast),
      direct_actuator_sorter_interval_ms: Configuration.Generic.get_loop_interval_ms(:medium),
      indirect_override_sorter_interval_ms: Configuration.Generic.get_loop_interval_ms(:extra_slow),
    ]
  end
end
