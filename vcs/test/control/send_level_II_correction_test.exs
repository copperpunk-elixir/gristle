...
#   test "SendLevelIICorrectionTest" do
#     IO.puts("SendLevelIICorrectionTest")
#     op_name = :levelII
...
#     assert_in_delta(MessageSorter.Sorter.get_value({:pv_cmds, :roll_rate}), 0, max_cmd_delta)
#     assert_in_delta(MessageSorter.Sorter.get_value({:pv_cmds, :pitch_rate}), 0, max_cmd_delta)
#     assert_in_delta(MessageSorter.Sorter.get_value({:pv_cmds, :yaw_rate}), 0, max_cmd_delta)
