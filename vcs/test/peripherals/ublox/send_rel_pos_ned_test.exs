defmodule Simulation.Ublox.SendRelPosNedTest do
  ...
  test "Spoof Accel", context do
    ...
    attitude = %{roll: 0.2, pitch: -0.12, yaw: 0.25*Common.Constants.pi_4()}
    bodyrate = %{rollrate: 0.0, pitchrate: 0.0, yawrate: -0.873}
    ...
    Enum.each(1..1000, fn x ->
      yaw = attitude.yaw - Common.Utils.Math.deg2rad(10*x)
